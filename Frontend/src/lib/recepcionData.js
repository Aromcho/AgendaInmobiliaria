...
export const RECEP = {
  TEAM: [{"name":"Cecilia","color":"#7257c9","init":"C"},{"name":"Paul","color":"#0e8a8a","init":"P"},{"name":"Fabiana","color":"#c2861a","init":"F"},{"name":"Pablo","color":"#2563eb","init":"P"},{"name":"Conrado","color":"#15784f","init":"C"},{"name":"Curly","color":"#b8791b","init":"C"}],
  STATUS: {

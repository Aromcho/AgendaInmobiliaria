...
/* Iconos SVG (stroke) -> window.Icons */
  ...
  const Icons = {
    ...
    Mail: (p) => S(p, [e("rect",{key:1,x:3,y:5,width:18,height:14,rx:2}), e("path",{key:2,d:"M4 7l8 6 8-6"})]),
    Users: (p) => S(p, [e("circle",{key:1,cx:9,cy:8,r:3.2}), e("path",{key:2,d:"M3 20c0-3.3 2.7-5.5 6-5.5s6 2.2 6 5.5"}), e("circle",{key:3,cx:17,cy:8.3,r:2.4}), e("path",{key:4,d:"M16 14.6c2.3.5 4 2.4 4 5.4"})]),
    WhatsApp: (p) => e("svg", Object.assign({ width: 18, height: 18, viewBox: "0 0 24 24", fill: "currentColor", stroke: "none" }, p),
